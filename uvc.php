<?php require 'connect.inc.php'; 
    ...
    if(isset($_GET['cid'])){
        $gy = $_GET['cid'];
        $q = "SELECT * FROM `product` where uid <> '$tyui' and cid = $gy";
      }
      else{
...
#view{
	background: rgba(0,0,0,0.2);float: right;height: 60px;font-size: 20px;padding-top: 20px; 
}
...
-->
		...
		<!-- <div style="height: 0px;float: right;"> -->
		 <a href="aboutus.html" style="font-size: 18px;float: right;margin-top: 24px;margin-right: 15px; color: white;">About Us</a>
    	 <a href="contactus.php" style="font-size: 18px;float: right;margin-top: 24px;margin-right: 15px;color: white;">Contact Us</a>
...
-->
<!--        <li><a></a></li>-->
<div style="width:90%;margin: 100px 0% 0% 15%">
	<!-- <div id="view" style="">
		<a href="" style="font-size: 20px;color: black;font-family: cursive;padding:0px 10px 0 10px;text-decoration: none;">View all</a>
	</div> -->
 ...
 ?>
  ...
  <li style="width: 250px; "><a href="buy.php?cid=<?php echo $jk['cid']?>"><?php echo $jk['cname'];?></a></li>
<?php } ?>
    </ul>
</div>
		<?php 
