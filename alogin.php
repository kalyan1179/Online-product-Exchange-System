...
<?php 
  ...
  window.location.href="alogin.php"</script>
	<?php 
...
<body>
	<div class="loginbox">
		<p><h1 style="color:tomato;font-family:times new roman;font-style:italic;font-weight: bold;font-stretch:ultra-expanded;margin-bottom: 15px;">Login</h1></p> 
