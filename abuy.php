<?php require 'connect.inc.php'; 
    ...
    if(isset($_GET['cid'])){
        $gy = $_GET['cid'];
        $q = "SELECT * FROM `product` where cid = $gy";
      }
...
-->
		...
		<a href="admin.php" id="admin" onclick="document.location=this.id+'.php';return false;">
...
<!--        <li><a></a></li>-->
 ...
 ?>
  ...
  <li style=" "><a href="abuy.php?cid=<?php echo $jk['cid']?>"><?php echo $jk['cname'];?></a></li>
<?php } ?>
    </ul>
		<?php 
		...
		<a href="aproduct.php?ids=<?php echo "".$cv; ?>" style="color: black;">
	<div class="divbox">
