<?php require 'connect.inc.php'; 
	...
	if(isset($_SESSION['id'])){
		$tyui = $_SESSION['id'];
		$q = "SELECT * FROM `product` where uid = '$tyui' and sold = 1";
...
*/
		...
		.divbox{
			float: left;
			width: 280px;height: 360px;background: white; margin-top: 0px;margin-bottom: 10px;margin-left: 45px;border-radius: 10px;/*border: 2px solid rgb(50,50,50);
			/*padding: 0 12px;*/
		}
		div {
